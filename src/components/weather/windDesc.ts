export const windDesc = [
  ...
  },
  {
    ...
    desc:
      "4-6 One can feel the wind. The leaves on the trees move, the wind can lift small streamers.",
    name: "Light breeze",
  },
  {
  ...
  },
  {
    ...
    desc:
      "11-16   The wind raises dust and loose papers, touches on the twigs and small branches, stretches larger flags and pennants",
    name: "Moderate breeze",
  },
  {
    speed_interval: [8.0, 10.8],
    desc:
      "17-21   Small trees in leaf begin to sway. The water begins little waves to peak",
    name: "Fresh Breeze",
  },
  {
    speed_interval: [10.8, 13.9],
    desc:
      "22-27   Large branches and smaller tribes moves. The whiz of telephone lines. It is difficult to use the umbrella. A resistance when running.",
    name: "Strong breeze",
  },
  {
  ...
  },
  {
    ...
    desc:
      "34-40   The wind break twigs of trees. It is hard to go against the wind.",
    name: "Gale",
  },
  {
